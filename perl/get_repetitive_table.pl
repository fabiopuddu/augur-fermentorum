...
foreach my $line (@REPDNA) {
	...
	$telo{$ERSNO}=(defined $LINE[10] and $LINE[10] ne "-1" and $LINE[10] ne "") ? sprintf "%.1f", $LINE[10] : "N/A" ;;
	push @SAMPLES, $ERSNO;
}
...
print "\n============================================================================================================================\n";
printf $header, ("ERS NO."," SAMPLE NAME", "REF", "║", "rDNA", "CUP1", "║", "Ty1", "Ty2", "Ty3", "Ty4", "Ty5", "║", "TELOMERS (rpm)", "║", "Mitochondria", "║");
print "============================================================================================================================";
...
print "REPETITIVE DNA QUANTIFICATION";
print "\n=========================================================================================================================================================================\n";
print "ERSNumber\tSample name\trDNA\tCUP1\tTy1\tTy2\tTy3\tTy4\tTy5\tTelomeres\tMitochondrial DNA\n";
print "=========================================================================================================================================================================\n";
